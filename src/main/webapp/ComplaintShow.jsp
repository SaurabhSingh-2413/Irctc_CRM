...
<html>
<head>
<link rel="stylesheet" href="css/ComplaintShow.css">
				...
				<div class="container-x">
					<div class="entryArea-1">
						<i class="fa-solid fa-ticket" id="train-logo"></i> <input
							...
							placeholder="Enter reference Number" name="Tnumber"
							id="inputarea">
			...
			<section>
				<div id="status-1">
                    <div class="trainComplaintId">
                        <h4>Complaint Details : ID - 20241231962</h4>
                    </div>
					...
					<div class="IncidentArea">
						<div class="IncidentDate">
							<h6>Incident Date : <span>31/12/2024 17:54</span></h6>
						</div>
						<div class="status">
