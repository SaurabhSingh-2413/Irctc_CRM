...
<link rel="stylesheet" href="css/BlankRunningStatus.css">
...
<title>Blank-Running-Status</title>
</head>
<body>
	<%
		...
		<div class="nav-item">
			<div class="nav-2">
				...
				<ul>
					...
					<li class="active"><a href="BlankRunningStatus.jsp"> <i class="fa-solid fa-train-subway"></i> <label
			...
			<h5 id="train-running-status">Train Running Status</h5>
				<form action="RunningStatus" method="post">
                    ...
                    <div class="start-date-1">
                    	<i class="fa-regular fa-calendar-days" id="calender-font"></i>
                        <input type="date" id="start-input" name="jrnyDate">
